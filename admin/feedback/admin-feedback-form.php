...
class evtb_feedback {
	...
	private $plugin_url     = EVENTS_BLOCK_URL;
	private $plugin_version = EVENTS_BLOCK_VERSION;
	private $plugin_name    = 'Events Block';
	private $plugin_slug    = 'events-block';
